...
@unittest.skip("Skipping all tests in TestPostObservation")
class TestPostObservation(unittest.TestCase):
    """PostObservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservation:
        """Test PostObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservation`
        """
        model = PostObservation()
        if include_optional:
            return PostObservation(
                observation = inaturalist_client.models.post_observation_observation.PostObservation_observation(
                    species_guess = '', 
                    taxon_id = 56, 
                    description = '', )
            )

...
@unittest.skip("Skipping all tests in TestPostFlagFlag")
class TestPostFlagFlag(unittest.TestCase):
    """PostFlagFlag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostFlagFlag:
        """Test PostFlagFlag
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostFlagFlag`
        """
        model = PostFlagFlag()
        if include_optional:
            return PostFlagFlag(

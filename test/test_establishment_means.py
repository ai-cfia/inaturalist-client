...
@unittest.skip("Skipping all tests in TestEstablishmentMeans")
class TestEstablishmentMeans(unittest.TestCase):
    """EstablishmentMeans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstablishmentMeans:
        """Test EstablishmentMeans
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `EstablishmentMeans`
        """
        model = EstablishmentMeans()
        if include_optional:
    ...
    def testEstablishmentMeans(self):
        """Test EstablishmentMeans"""

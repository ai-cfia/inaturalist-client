...
@unittest.skip("Skipping all tests in TestNearbyPlacesResponse")
class TestNearbyPlacesResponse(unittest.TestCase):
    """NearbyPlacesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearbyPlacesResponse:
        """Test NearbyPlacesResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NearbyPlacesResponse`
        """
        model = NearbyPlacesResponse()
        if include_optional:
            return NearbyPlacesResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = inaturalist_client.models.nearby_places_response_all_of_results.NearbyPlacesResponse_allOf_results(
                    standard = [
                        null
                        ], 
                    community = [
    ...
    def testNearbyPlacesResponse(self):
        """Test NearbyPlacesResponse"""

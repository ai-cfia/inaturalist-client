...
@unittest.skip("Skipping all tests in TestPostsApi")
class TestPostsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_posts_for_user_get(self) -> None:
        """Test case for posts_for_user_get
    ...
    async def test_posts_id_delete(self) -> None:
    ...
    async def test_posts_id_put(self) -> None:
        """Test case for posts_id_put

        Post Update
        """
        pass

    async def test_posts_post(self) -> None:

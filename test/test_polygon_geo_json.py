...
@unittest.skip("Skipping all tests in TestPolygonGeoJson")
class TestPolygonGeoJson(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PolygonGeoJson:
        """Test PolygonGeoJson
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PolygonGeoJson`
        """
        model = PolygonGeoJson()
        if include_optional:

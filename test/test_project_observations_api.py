...
@unittest.skip("Skipping all tests in TestProjectObservationsApi")
class TestProjectObservationsApi(unittest.IsolatedAsyncioTestCase):
    """ProjectObservationsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ProjectObservationsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_project_observations_id_delete(self) -> None:
        """Test case for project_observations_id_delete

        Project Observation Delete
        """
        pass

    async def test_project_observations_id_put(self) -> None:
        """Test case for project_observations_id_put

        Project Observation Update
        """
        pass

    async def test_project_observations_post(self) -> None:
        """Test case for project_observations_post

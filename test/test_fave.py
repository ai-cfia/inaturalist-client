...
@unittest.skip("Skipping all tests in TestFave")
class TestFave(unittest.TestCase):
    """Fave unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Fave:
        """Test Fave
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Fave`
        """
        model = Fave()
        if include_optional:
            return Fave(

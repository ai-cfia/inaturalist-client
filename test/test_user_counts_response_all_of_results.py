...
@unittest.skip("Skipping all tests in TestUserCountsResponseAllOfResults")
class TestUserCountsResponseAllOfResults(unittest.TestCase):
    """UserCountsResponseAllOfResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCountsResponseAllOfResults:
        """Test UserCountsResponseAllOfResults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserCountsResponseAllOfResults`
        """
        model = UserCountsResponseAllOfResults()
        if include_optional:
            return UserCountsResponseAllOfResults(
                count = 56,
    ...
    def testUserCountsResponseAllOfResults(self):
        """Test UserCountsResponseAllOfResults"""

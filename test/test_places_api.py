...
@unittest.skip("Skipping all tests in TestPlacesApi")
class TestPlacesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_places_autocomplete_get(self) -> None:
        """Test case for places_autocomplete_get

        Place Autocomplete
        """
        pass

    async def test_places_id_get(self) -> None:
    ...
    async def test_places_nearby_get(self) -> None:
        """Test case for places_nearby_get

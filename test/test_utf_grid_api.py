...
@unittest.skip("Skipping all tests in TestUTFGridApi")
class TestUTFGridApi(unittest.IsolatedAsyncioTestCase):
    """UTFGridApi unit test stubs"""
    ...
    async def test_colored_heatmap_zoom_xy_grid_json_get(self) -> None:
        """Test case for colored_heatmap_zoom_xy_grid_json_get

        Colored Heatmap Tiles UTFGrid
        """
        pass

    async def test_grid_zoom_xy_grid_json_get(self) -> None:
        """Test case for grid_zoom_xy_grid_json_get

        Grid Tiles UTFGrid
        """
        pass

    async def test_heatmap_zoom_xy_grid_json_get(self) -> None:
        """Test case for heatmap_zoom_xy_grid_json_get

        Heatmap Tiles UTFGrid
        """
        pass

    async def test_points_zoom_xy_grid_json_get(self) -> None:
        """Test case for points_zoom_xy_grid_json_get

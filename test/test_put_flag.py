...
@unittest.skip("Skipping all tests in TestPutFlag")
class TestPutFlag(unittest.TestCase):
    """PutFlag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutFlag:
        """Test PutFlag
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PutFlag`
        """
        model = PutFlag()
        if include_optional:
            return PutFlag(
                flag = inaturalist_client.models.put_flag_flag.PutFlag_flag(
                    resolved = True, )
            )
        else:
            return PutFlag(

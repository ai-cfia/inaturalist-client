...
@unittest.skip("Skipping all tests in TestTaxaShowResponse")
class TestTaxaShowResponse(unittest.TestCase):
    """TaxaShowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxaShowResponse:
        """Test TaxaShowResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxaShowResponse`
        """
        model = TaxaShowResponse()
        if include_optional:
            return TaxaShowResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = [

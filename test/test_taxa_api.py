...
@unittest.skip("Skipping all tests in TestTaxaApi")
class TestTaxaApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_taxa_autocomplete_get(self) -> None:
        """Test case for taxa_autocomplete_get

        Taxon Autocomplete
        """
        pass

    async def test_taxa_get(self) -> None:
        """Test case for taxa_get

        Taxon Search
        """
        pass

    async def test_taxa_id_get(self) -> None:
        """Test case for taxa_id_get

...
@unittest.skip("Skipping all tests in TestNearbyPlacesResponseAllOfResults")
class TestNearbyPlacesResponseAllOfResults(unittest.TestCase):
    """NearbyPlacesResponseAllOfResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearbyPlacesResponseAllOfResults:
        """Test NearbyPlacesResponseAllOfResults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NearbyPlacesResponseAllOfResults`
        """
        model = NearbyPlacesResponseAllOfResults()
        if include_optional:
            return NearbyPlacesResponseAllOfResults(
                standard = [
                    null
                    ],
                community = [
    ...
    def testNearbyPlacesResponseAllOfResults(self):
        """Test NearbyPlacesResponseAllOfResults"""

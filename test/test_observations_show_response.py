...
@unittest.skip("Skipping all tests in TestObservationsShowResponse")
class TestObservationsShowResponse(unittest.TestCase):
    """ObservationsShowResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationsShowResponse:
        """Test ObservationsShowResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ObservationsShowResponse`
        """
        model = ObservationsShowResponse()
        if include_optional:
            return ObservationsShowResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = [
    ...
    def testObservationsShowResponse(self):
        """Test ObservationsShowResponse"""

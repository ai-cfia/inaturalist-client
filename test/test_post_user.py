...
@unittest.skip("Skipping all tests in TestPostUser")
class TestPostUser(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostUser:
        """Test PostUser
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostUser`
        """
        model = PostUser()
        if include_optional:
            return PostUser(
                user = inaturalist_client.models.post_user_user.PostUser_user(
                    login = '', 
                    email = '', 
                    name = '', 
                    locale = '', 

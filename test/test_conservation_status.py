...
@unittest.skip("Skipping all tests in TestConservationStatus")
class TestConservationStatus(unittest.TestCase):
    """ConservationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConservationStatus:
        """Test ConservationStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ConservationStatus`
        """
    ...
    def testConservationStatus(self):
        """Test ConservationStatus"""

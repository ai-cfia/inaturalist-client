...
@unittest.skip("Skipping all tests in TestPostUserUser")
class TestPostUserUser(unittest.TestCase):
    """PostUserUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostUserUser:
        """Test PostUserUser
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostUserUser`
        """
        model = PostUserUser()
        if include_optional:
            return PostUserUser(
                ...
                place_id = 56,
                description = '',
                icon = inaturalist_client.models.icon.icon()
            )
        else:
            return PostUserUser(
        )

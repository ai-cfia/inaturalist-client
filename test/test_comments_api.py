...
@unittest.skip("Skipping all tests in TestCommentsApi")
class TestCommentsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_comments_id_delete(self) -> None:
    ...
    async def test_comments_id_put(self) -> None:
    ...
    async def test_comments_post(self) -> None:

...
@unittest.skip("Skipping all tests in TestIdentificationsApi")
class TestIdentificationsApi(unittest.IsolatedAsyncioTestCase):
    """IdentificationsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = IdentificationsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_identifications_categories_get(self) -> None:
        """Test case for identifications_categories_get

        Identification Categories
        """
        pass

    async def test_identifications_get(self) -> None:
        """Test case for identifications_get

        Identification Search
        """
        pass

    async def test_identifications_id_delete(self) -> None:
        """Test case for identifications_id_delete

        Identification Delete
        """
        pass

    async def test_identifications_id_get(self) -> None:
        """Test case for identifications_id_get

        Identification Details
        """
        pass

    async def test_identifications_id_put(self) -> None:
        """Test case for identifications_id_put

        Identification Update
        """
        pass

    async def test_identifications_identifiers_get(self) -> None:
        """Test case for identifications_identifiers_get

        Identification Identifiers
        """
        pass

    async def test_identifications_observers_get(self) -> None:
        """Test case for identifications_observers_get

        Identification Observers
        """
        pass

    async def test_identifications_post(self) -> None:
        """Test case for identifications_post

        Identification Create
        """
        pass

    async def test_identifications_recent_taxa_get(self) -> None:
        """Test case for identifications_recent_taxa_get

        Identification Recent Taxa
        """
        pass

    async def test_identifications_similar_species_get(self) -> None:
        """Test case for identifications_similar_species_get

        Identification Similar Species
        """
        pass

    async def test_identifications_species_counts_get(self) -> None:
        """Test case for identifications_species_counts_get

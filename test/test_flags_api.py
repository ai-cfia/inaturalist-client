...
@unittest.skip("Skipping all tests in TestFlagsApi")
class TestFlagsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_flags_id_delete(self) -> None:
        """Test case for flags_id_delete

        Flag Delete
        """
        pass

    async def test_flags_id_put(self) -> None:
        """Test case for flags_id_put

        Flag Update
        """
        pass

    async def test_flags_post(self) -> None:
        """Test case for flags_post

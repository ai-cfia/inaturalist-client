...
@unittest.skip("Skipping all tests in TestIdentificationsResponse")
class TestIdentificationsResponse(unittest.TestCase):
    """IdentificationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentificationsResponse:
        """Test IdentificationsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `IdentificationsResponse`
        """
        model = IdentificationsResponse()
        if include_optional:
            return IdentificationsResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = [
    ...
    def testIdentificationsResponse(self):
        """Test IdentificationsResponse"""

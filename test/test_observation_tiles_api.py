...
@unittest.skip("Skipping all tests in TestObservationTilesApi")
class TestObservationTilesApi(unittest.IsolatedAsyncioTestCase):
    """ObservationTilesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ObservationTilesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_colored_heatmap_zoom_xy_png_get(self) -> None:
        """Test case for colored_heatmap_zoom_xy_png_get

        Colored Heatmap Tiles
        """
        pass

    async def test_grid_zoom_xy_png_get(self) -> None:
        """Test case for grid_zoom_xy_png_get

        Grid Tiles
        """
        pass

    async def test_heatmap_zoom_xy_png_get(self) -> None:
        """Test case for heatmap_zoom_xy_png_get

        Heatmap Tiles
        """
        pass

    async def test_points_zoom_xy_png_get(self) -> None:
        """Test case for points_zoom_xy_png_get

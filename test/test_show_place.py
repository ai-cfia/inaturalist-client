...
@unittest.skip("Skipping all tests in TestShowPlace")
class TestShowPlace(unittest.TestCase):
    """ShowPlace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowPlace:
        """Test ShowPlace
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShowPlace`
        """
        model = ShowPlace()
        if include_optional:
            return ShowPlace(
                ...
                bbox_area = 1.337,
                geometry_geojson = inaturalist_client.models.polygon_geo_json.PolygonGeoJson(
                    type = '', 
                    coordinates = [
                        [
                            [

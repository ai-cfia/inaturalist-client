...
@unittest.skip("Skipping all tests in TestAnnotationsApi")
class TestAnnotationsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_annotations_id_delete(self) -> None:
    ...
    async def test_annotations_post(self) -> None:
    ...
    async def test_votes_unvote_annotation_id_delete(self) -> None:
        """Test case for votes_unvote_annotation_id_delete

        Annotation Unvote
        """
        pass

    async def test_votes_vote_annotation_id_post(self) -> None:
        """Test case for votes_vote_annotation_id_post

...
@unittest.skip("Skipping all tests in TestPlacesResponse")
class TestPlacesResponse(unittest.TestCase):
    """PlacesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlacesResponse:
        """Test PlacesResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PlacesResponse`
        """

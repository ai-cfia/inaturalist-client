...
@unittest.skip("Skipping all tests in TestProjectsApi")
class TestProjectsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_projects_autocomplete_get(self) -> None:
        """Test case for projects_autocomplete_get
    ...
    async def test_projects_id_add_post(self) -> None:
        """Test case for projects_id_add_post
    ...
    async def test_projects_id_join_post(self) -> None:
        """Test case for projects_id_join_post

        Projects Join
        """
        pass

    async def test_projects_id_leave_delete(self) -> None:
        """Test case for projects_id_leave_delete

        Projects Leave
        """
        pass

    async def test_projects_id_members_get(self) -> None:
        """Test case for projects_id_members_get

        Project Members
        """
        pass

    async def test_projects_id_membership_get(self) -> None:
        """Test case for projects_id_membership_get

        Membership of current user
        """
        pass

    async def test_projects_id_remove_delete(self) -> None:
        """Test case for projects_id_remove_delete

        Project Add
        """
        pass

    async def test_projects_id_subscriptions_get(self) -> None:
        """Test case for projects_id_subscriptions_get

        Project Subscriptions
        """
        pass

    async def test_subscriptions_project_id_subscribe_post(self) -> None:
        """Test case for subscriptions_project_id_subscribe_post

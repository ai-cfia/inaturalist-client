...
@unittest.skip("Skipping all tests in TestObservationTaxon")
class TestObservationTaxon(unittest.TestCase):
    """ObservationTaxon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationTaxon:
        """Test ObservationTaxon
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ObservationTaxon`
        """
        ...
        if include_optional:
            return ObservationTaxon(
                ...
                ancestry = '',
                conservation_status = inaturalist_client.models.raw_conservation_status.RawConservationStatus(
                    source_id = 56, 
                    authority = '', 
                    status = '', 
                    status_name = '', 
                    ...
                    geoprivacy = '', ),
                endemic = True,
                establishment_means = inaturalist_client.models.establishment_means.EstablishmentMeans(
                    establishment_means = '', 
                    place = inaturalist_client.models.core_place.CorePlace(
                        id = 56, 
                        name = '', 
                        display_name = '', ), ),
                introduced = True,

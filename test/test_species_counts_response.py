...
@unittest.skip("Skipping all tests in TestSpeciesCountsResponse")
class TestSpeciesCountsResponse(unittest.TestCase):
    """SpeciesCountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpeciesCountsResponse:
        """Test SpeciesCountsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpeciesCountsResponse`
        """
        model = SpeciesCountsResponse()
        if include_optional:
            return SpeciesCountsResponse(
                ...
                per_page = 56,
                results = [
                    inaturalist_client.models.species_counts_response_all_of_results.SpeciesCountsResponse_allOf_results(
                        count = 56, 
                        taxon = null, )
                    ]
            )
    ...
    def testSpeciesCountsResponse(self):
        """Test SpeciesCountsResponse"""

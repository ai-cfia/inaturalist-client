...
@unittest.skip("Skipping all tests in TestObservationsObserversResponse")
class TestObservationsObserversResponse(unittest.TestCase):
    """ObservationsObserversResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationsObserversResponse:
        """Test ObservationsObserversResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ObservationsObserversResponse`
        """
        model = ObservationsObserversResponse()
        if include_optional:
            return ObservationsObserversResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = [
                    inaturalist_client.models.observations_observers_response_all_of_results.ObservationsObserversResponse_allOf_results(
    ...
    def testObservationsObserversResponse(self):
        """Test ObservationsObserversResponse"""

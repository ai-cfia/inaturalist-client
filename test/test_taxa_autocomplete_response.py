...
@unittest.skip("Skipping all tests in TestTaxaAutocompleteResponse")
class TestTaxaAutocompleteResponse(unittest.TestCase):
    """TaxaAutocompleteResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxaAutocompleteResponse:
        """Test TaxaAutocompleteResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxaAutocompleteResponse`
        """
        model = TaxaAutocompleteResponse()
        if include_optional:
            return TaxaAutocompleteResponse(
                total_results = 56,
                page = 56,
                per_page = 56,
                results = [
    ...
    def testTaxaAutocompleteResponse(self):
        """Test TaxaAutocompleteResponse"""

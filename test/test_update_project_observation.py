...
@unittest.skip("Skipping all tests in TestUpdateProjectObservation")
class TestUpdateProjectObservation(unittest.TestCase):
    """UpdateProjectObservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateProjectObservation:
        """Test UpdateProjectObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateProjectObservation`
        """
        model = UpdateProjectObservation()
        if include_optional:
            return UpdateProjectObservation(
                project_observation = inaturalist_client.models.update_project_observation_project_observation.UpdateProjectObservation_project_observation(
                    project_id = 56, 
                    observation_id = 56, 
                    prefers_curator_coordinate_access = True, )
            )
        else:
            return UpdateProjectObservation(
        )
    ...
    def testUpdateProjectObservation(self):
        """Test UpdateProjectObservation"""

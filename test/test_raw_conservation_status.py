...
@unittest.skip("Skipping all tests in TestRawConservationStatus")
class TestRawConservationStatus(unittest.TestCase):
    """RawConservationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawConservationStatus:
        """Test RawConservationStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RawConservationStatus`
        """
        model = RawConservationStatus()
        if include_optional:
            return RawConservationStatus(
                source_id = 56,
                authority = '',
                status = '',
                status_name = '',
    ...
    def testRawConservationStatus(self):
        """Test RawConservationStatus"""

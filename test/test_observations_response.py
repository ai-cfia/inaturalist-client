...
@unittest.skip("Skipping all tests in TestObservationsResponse")
class TestObservationsResponse(unittest.TestCase):
    """ObservationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObservationsResponse:
        """Test ObservationsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ObservationsResponse`
        """
        model = ObservationsResponse()
        if include_optional:
            return ObservationsResponse(
                ...
                per_page = 56,
                results = [
                    inaturalist_client.models.observation.Observation(
                        id = 56, 
    ...
    def testObservationsResponse(self):
        """Test ObservationsResponse"""

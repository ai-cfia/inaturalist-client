...
@unittest.skip("Skipping all tests in TestPostObservationVote")
class TestPostObservationVote(unittest.TestCase):
    """PostObservationVote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservationVote:
        """Test PostObservationVote
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationVote`
        """
        model = PostObservationVote()
        if include_optional:
            return PostObservationVote(
                vote = 'up',
                scope = 'needs_id'
            )
        else:
    ...
    def testPostObservationVote(self):
        """Test PostObservationVote"""

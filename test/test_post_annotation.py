...
@unittest.skip("Skipping all tests in TestPostAnnotation")
class TestPostAnnotation(unittest.TestCase):
    """PostAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAnnotation:
        """Test PostAnnotation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostAnnotation`
        """
        model = PostAnnotation()
        if include_optional:
            return PostAnnotation(
                annotation = inaturalist_client.models.post_annotation_annotation.PostAnnotation_annotation(

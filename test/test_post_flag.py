...
@unittest.skip("Skipping all tests in TestPostFlag")
class TestPostFlag(unittest.TestCase):
    """PostFlag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostFlag:
        """Test PostFlag
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostFlag`
        """
        model = PostFlag()
        if include_optional:
            return PostFlag(
                flag = inaturalist_client.models.post_flag_flag.PostFlag_flag(
                    flaggable_type = 'Comment', 
                    flaggable_id = 56, 
                    flag = inaturalist_client.models.flag.flag(), ),
                flag_explanation = ''
            )
        else:
            return PostFlag(

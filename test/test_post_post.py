...
@unittest.skip("Skipping all tests in TestPostPost")
class TestPostPost(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostPost:
        """Test PostPost
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostPost`
        """
        model = PostPost()
        if include_optional:
            return PostPost(
                commit = 'Publish',
                post = inaturalist_client.models.post_post_post.PostPost_post(
                    title = '', 
                    body = '', 

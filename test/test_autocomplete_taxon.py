...
@unittest.skip("Skipping all tests in TestAutocompleteTaxon")
class TestAutocompleteTaxon(unittest.TestCase):
    """AutocompleteTaxon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutocompleteTaxon:
        """Test AutocompleteTaxon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutocompleteTaxon`
        """
        model = AutocompleteTaxon()
        if include_optional:
            return AutocompleteTaxon(
                id = 56,
                iconic_taxon_id = 56,
                iconic_taxon_name = '',
                is_active = True,
    ...
    def testAutocompleteTaxon(self):
        """Test AutocompleteTaxon"""

...
@unittest.skip("Skipping all tests in TestPostProjectAdd")
class TestPostProjectAdd(unittest.TestCase):
    """PostProjectAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostProjectAdd:
        """Test PostProjectAdd
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostProjectAdd`
        """
        model = PostProjectAdd()
        if include_optional:
            return PostProjectAdd(
                observation_id = 56
            )
        else:
            return PostProjectAdd(

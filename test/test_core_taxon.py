...
@unittest.skip("Skipping all tests in TestCoreTaxon")
class TestCoreTaxon(unittest.TestCase):
    """CoreTaxon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreTaxon:
        """Test CoreTaxon
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CoreTaxon`
        """
        model = CoreTaxon()
        if include_optional:
            return CoreTaxon(

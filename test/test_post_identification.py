...
@unittest.skip("Skipping all tests in TestPostIdentification")
class TestPostIdentification(unittest.TestCase):
    """PostIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostIdentification:
        """Test PostIdentification
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostIdentification`
        """
        model = PostIdentification()
        if include_optional:
            return PostIdentification(
                identification = inaturalist_client.models.post_identification_identification.PostIdentification_identification(
                    observation_id = 56, 
                    taxon_id = 56, 
                    current = True, 
                    body = '', )
    ...
    def testPostIdentification(self):
        """Test PostIdentification"""

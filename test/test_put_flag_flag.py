...
@unittest.skip("Skipping all tests in TestPutFlagFlag")
class TestPutFlagFlag(unittest.TestCase):
    """PutFlagFlag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutFlagFlag:
        """Test PutFlagFlag
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PutFlagFlag`
        """
        model = PutFlagFlag()
        if include_optional:
            return PutFlagFlag(

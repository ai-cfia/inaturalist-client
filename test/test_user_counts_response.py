...
@unittest.skip("Skipping all tests in TestUserCountsResponse")
class TestUserCountsResponse(unittest.TestCase):
    """UserCountsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserCountsResponse:
        """Test UserCountsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserCountsResponse`
        """
        model = UserCountsResponse()
        if include_optional:
            return UserCountsResponse(
                ...
                per_page = 56,
                results = [
                    inaturalist_client.models.user_counts_response_all_of_results.UserCountsResponse_allOf_results(
                        count = 56, 
    ...
    def testUserCountsResponse(self):
        """Test UserCountsResponse"""

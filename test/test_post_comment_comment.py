...
@unittest.skip("Skipping all tests in TestPostCommentComment")
class TestPostCommentComment(unittest.TestCase):
    """PostCommentComment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostCommentComment:
        """Test PostCommentComment
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostCommentComment`
        """
        model = PostCommentComment()
        if include_optional:
    ...
    def testPostCommentComment(self):
        """Test PostCommentComment"""

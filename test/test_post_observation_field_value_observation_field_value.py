...
@unittest.skip(
    "Skipping all tests in TestPostObservationFieldValueObservationFieldValue"
)
class TestPostObservationFieldValueObservationFieldValue(unittest.TestCase):
    """PostObservationFieldValueObservationFieldValue unit test stubs"""
    ...
    def make_instance(
        ...
        """Test PostObservationFieldValueObservationFieldValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationFieldValueObservationFieldValue`
        """
        model = PostObservationFieldValueObservationFieldValue()
        if include_optional:
            return PostObservationFieldValueObservationFieldValue(
                observation_id = 56,
    ...
    def testPostObservationFieldValueObservationFieldValue(self):
        """Test PostObservationFieldValueObservationFieldValue"""

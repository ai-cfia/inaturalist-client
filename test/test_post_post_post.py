...
@unittest.skip("Skipping all tests in TestPostPostPost")
class TestPostPostPost(unittest.TestCase):
    """PostPostPost unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPostPost:
        """Test PostPostPost
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostPostPost`
        """
        model = PostPostPost()
        if include_optional:
            return PostPostPost(

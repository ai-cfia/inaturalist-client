...
@unittest.skip("Skipping all tests in TestObservationFieldValuesApi")
class TestObservationFieldValuesApi(unittest.IsolatedAsyncioTestCase):
    """ObservationFieldValuesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ObservationFieldValuesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_observation_field_values_id_delete(self) -> None:
        """Test case for observation_field_values_id_delete

        Observation Field Value Delete
        """
        pass

    async def test_observation_field_values_id_put(self) -> None:
        """Test case for observation_field_values_id_put

        Observation Field Value Update
        """
        pass

    async def test_observation_field_values_post(self) -> None:
        """Test case for observation_field_values_post

...
@unittest.skip("Skipping all tests in TestNonOwnerIdentification")
class TestNonOwnerIdentification(unittest.TestCase):
    """NonOwnerIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NonOwnerIdentification:
        """Test NonOwnerIdentification
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `NonOwnerIdentification`
        """
        model = NonOwnerIdentification()
        if include_optional:
            return NonOwnerIdentification(
                id = 56,
                body = '',
    ...
    def testNonOwnerIdentification(self):
        """Test NonOwnerIdentification"""

...
@unittest.skip("Skipping all tests in TestTaxonConservationStatus")
class TestTaxonConservationStatus(unittest.TestCase):
    """TaxonConservationStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxonConservationStatus:
        """Test TaxonConservationStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxonConservationStatus`
        """
        model = TaxonConservationStatus()
        if include_optional:
            return TaxonConservationStatus(
                source_id = 56,
                authority = '',
                status = '',
                status_name = '',
    ...
    def testTaxonConservationStatus(self):
        """Test TaxonConservationStatus"""

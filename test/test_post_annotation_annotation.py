...
@unittest.skip("Skipping all tests in TestPostAnnotationAnnotation")
class TestPostAnnotationAnnotation(unittest.TestCase):
    """PostAnnotationAnnotation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAnnotationAnnotation:
        """Test PostAnnotationAnnotation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostAnnotationAnnotation`
        """
        model = PostAnnotationAnnotation()
        if include_optional:
            return PostAnnotationAnnotation(
                resource_type = 'Observation',
                resource_id = 56,
                controlled_attribute_id = 56,
                controlled_value_id = 56
            )
        else:
            return PostAnnotationAnnotation(
        )
    ...
    def testPostAnnotationAnnotation(self):
        """Test PostAnnotationAnnotation"""

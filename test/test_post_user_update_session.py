...
@unittest.skip("Skipping all tests in TestPostUserUpdateSession")
class TestPostUserUpdateSession(unittest.TestCase):
    """PostUserUpdateSession unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostUserUpdateSession:
        """Test PostUserUpdateSession
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostUserUpdateSession`
        """
        model = PostUserUpdateSession()
        if include_optional:
            return PostUserUpdateSession(
                preferred_taxon_page_ancestors_shown = True,
                preferred_taxon_page_place_id = 56,
                preferred_taxon_page_tab = '',
                prefers_skip_coarer_id_modal = True,
                prefers_hide_obs_show_annotations = True,
                prefers_hide_obs_show_projects = True,
                prefers_hide_obs_show_tags = True,
                prefers_hide_obs_show_observation_fields = True,
                prefers_hide_obs_show_identifiers = True,
                prefers_hide_obs_show_copyright = True,
                prefers_hide_obs_show_quality_metrics = True
            )
        else:
            return PostUserUpdateSession(
        )
    ...
    def testPostUserUpdateSession(self):
        """Test PostUserUpdateSession"""

...
@unittest.skip("Skipping all tests in TestUpdateProjectObservationProjectObservation")
class TestUpdateProjectObservationProjectObservation(unittest.TestCase):
    """UpdateProjectObservationProjectObservation unit test stubs"""
    ...
    def make_instance(
        ...
        """Test UpdateProjectObservationProjectObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdateProjectObservationProjectObservation`
        """
        model = UpdateProjectObservationProjectObservation()
        if include_optional:
            return UpdateProjectObservationProjectObservation(
                project_id = 56,
                observation_id = 56,
    ...
    def testUpdateProjectObservationProjectObservation(self):
        """Test UpdateProjectObservationProjectObservation"""

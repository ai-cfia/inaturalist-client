...
@unittest.skip("Skipping all tests in TestPostMessageMessage")
class TestPostMessageMessage(unittest.TestCase):
    """PostMessageMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostMessageMessage:
        """Test PostMessageMessage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostMessageMessage`
        """
        model = PostMessageMessage()
        if include_optional:
            return PostMessageMessage(
                to_user_id = 56,
                thread_id = 56,
                subject = '',
                body = ''
    ...
    def testPostMessageMessage(self):
        """Test PostMessageMessage"""

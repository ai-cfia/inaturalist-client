...
@unittest.skip("Skipping all tests in TestControlledTermsApi")
class TestControlledTermsApi(unittest.IsolatedAsyncioTestCase):
    """ControlledTermsApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ControlledTermsApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_controlled_terms_for_taxon_get(self) -> None:
        """Test case for controlled_terms_for_taxon_get

        Terms for Taxon
        """
        pass

    async def test_controlled_terms_get(self) -> None:
        """Test case for controlled_terms_get

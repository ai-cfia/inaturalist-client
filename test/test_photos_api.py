...
@unittest.skip("Skipping all tests in TestPhotosApi")
class TestPhotosApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_photos_post(self) -> None:
        """Test case for photos_post

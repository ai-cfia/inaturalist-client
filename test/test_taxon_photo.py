...
@unittest.skip("Skipping all tests in TestTaxonPhoto")
class TestTaxonPhoto(unittest.TestCase):
    """TaxonPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxonPhoto:
        """Test TaxonPhoto
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TaxonPhoto`
        """
        model = TaxonPhoto()
        if include_optional:
            return TaxonPhoto(

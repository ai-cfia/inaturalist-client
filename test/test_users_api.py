...
@unittest.skip("Skipping all tests in TestUsersApi")
class TestUsersApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_users_autocomplete_get(self) -> None:
        """Test case for users_autocomplete_get
    ...
    async def test_users_id_mute_delete(self) -> None:
        """Test case for users_id_mute_delete

        Unmute a User
        """
        pass

    async def test_users_id_mute_post(self) -> None:
        """Test case for users_id_mute_post

        Mute a User
        """
        pass

    async def test_users_id_projects_get(self) -> None:
        """Test case for users_id_projects_get
    ...
    async def test_users_resend_confirmation_post(self) -> None:
        """Test case for users_resend_confirmation_post

        User Resend Confirmation
        """
        pass

    async def test_users_update_session_put(self) -> None:
        """Test case for users_update_session_put

...
@unittest.skip("Skipping all tests in TestPostQuality")
class TestPostQuality(unittest.TestCase):
    """PostQuality unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostQuality:
        """Test PostQuality
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostQuality`
        """
        model = PostQuality()
        if include_optional:
            return PostQuality(

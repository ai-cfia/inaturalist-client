...
@unittest.skip("Skipping all tests in TestPostObservationFieldValue")
class TestPostObservationFieldValue(unittest.TestCase):
    """PostObservationFieldValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservationFieldValue:
        """Test PostObservationFieldValue
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationFieldValue`
        """
        model = PostObservationFieldValue()
        if include_optional:
            return PostObservationFieldValue(
                observation_field_value = inaturalist_client.models.post_observation_field_value_observation_field_value.PostObservationFieldValue_observation_field_value(
                    observation_id = 56, 
                    observation_field_id = 56, 
                    value = '', )
            )
        else:
            return PostObservationFieldValue(
    ...
    def testPostObservationFieldValue(self):
        """Test PostObservationFieldValue"""

...
@unittest.skip("Skipping all tests in TestSpeciesCountsResponseAllOfResults")
class TestSpeciesCountsResponseAllOfResults(unittest.TestCase):
    """SpeciesCountsResponseAllOfResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpeciesCountsResponseAllOfResults:
        """Test SpeciesCountsResponseAllOfResults
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SpeciesCountsResponseAllOfResults`
        """
        model = SpeciesCountsResponseAllOfResults()
        if include_optional:
            return SpeciesCountsResponseAllOfResults(
                count = 56,
                taxon = None
            )
        else:
    ...
    def testSpeciesCountsResponseAllOfResults(self):
        """Test SpeciesCountsResponseAllOfResults"""

...
@unittest.skip("Skipping all tests in TestPostObservationPhotoObservationPhoto")
class TestPostObservationPhotoObservationPhoto(unittest.TestCase):
    """PostObservationPhotoObservationPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservationPhotoObservationPhoto:
        """Test PostObservationPhotoObservationPhoto
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationPhotoObservationPhoto`
        """
        model = PostObservationPhotoObservationPhoto()
        if include_optional:
            return PostObservationPhotoObservationPhoto(
                observation_id = 56
            )
        else:
            return PostObservationPhotoObservationPhoto(
    ...
    def testPostObservationPhotoObservationPhoto(self):
        """Test PostObservationPhotoObservationPhoto"""

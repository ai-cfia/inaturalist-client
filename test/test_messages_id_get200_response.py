...
@unittest.skip("Skipping all tests in TestMessagesIdGet200Response")
class TestMessagesIdGet200Response(unittest.TestCase):
    """MessagesIdGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessagesIdGet200Response:
        """Test MessagesIdGet200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `MessagesIdGet200Response`
        """
        model = MessagesIdGet200Response()
        if include_optional:
            return MessagesIdGet200Response(
                reply_to_user = inaturalist_client.models.user.User(
                    id = 56, 
                    icon_content_type = '', 
                    icon_file_name = '', 
                    icon = '', 
                    ...
                    name = '', ),
                thread_id = 56,
                flaggable_message_id = 56,
                results = [
                    inaturalist_client.models.message.Message(
                        id = 56, 
                        subject = '', 
                        body = '', 
                        user_id = 56, 
                        to_user = inaturalist_client.models.user.User(
                            id = 56, 
                            icon_content_type = '', 
                            icon_file_name = '', 
                            icon = '', 
                            ...
                            login = '', 
                            name = '', ), 
                        from_user = inaturalist_client.models.user.User(
                            id = 56, 
                            icon_content_type = '', 
                            icon_file_name = '', 
                            icon = '', 
    ...
    def testMessagesIdGet200Response(self):
        """Test MessagesIdGet200Response"""

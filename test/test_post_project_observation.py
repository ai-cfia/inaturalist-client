...
@unittest.skip("Skipping all tests in TestPostProjectObservation")
class TestPostProjectObservation(unittest.TestCase):
    """PostProjectObservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostProjectObservation:
        """Test PostProjectObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostProjectObservation`
        """
        model = PostProjectObservation()
        if include_optional:
            return PostProjectObservation(
                project_id = 56,
                observation_id = 56
            )
        else:
    ...
    def testPostProjectObservation(self):
        """Test PostProjectObservation"""

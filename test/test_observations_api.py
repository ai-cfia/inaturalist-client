...
@unittest.skip("Skipping all tests in TestObservationsApi")
class TestObservationsApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_observations_deleted_get(self) -> None:
        """Test case for observations_deleted_get

        Observations Deleted
        """
        pass

    async def test_observations_get(self) -> None:
    ...
    async def test_observations_histogram_get(self) -> None:
        """Test case for observations_histogram_get

        Observation Histogram
        """
        pass

    async def test_observations_id_delete(self) -> None:
        """Test case for observations_id_delete

        Observation Delete
        """
        pass

    async def test_observations_id_fave_post(self) -> None:
        """Test case for observations_id_fave_post

        Observations Fave
        """
        pass

    async def test_observations_id_get(self) -> None:
        """Test case for observations_id_get

        Observation Details
        """
        pass

    async def test_observations_id_put(self) -> None:
        """Test case for observations_id_put

        Observation Update
        """
        pass

    async def test_observations_id_quality_metric_delete(self) -> None:
        """Test case for observations_id_quality_metric_delete

        Quality Metric Delete
        """
        pass

    async def test_observations_id_quality_metric_post(self) -> None:
        """Test case for observations_id_quality_metric_post

        Quality Metric Set
        """
        pass

    async def test_observations_id_review_post(self) -> None:
        """Test case for observations_id_review_post

        Observations Review
        """
        pass

    async def test_observations_id_subscriptions_get(self) -> None:
        """Test case for observations_id_subscriptions_get

        Observation Subscriptions
        """
        pass

    async def test_observations_id_taxon_summary_get(self) -> None:
        """Test case for observations_id_taxon_summary_get

        Observation Taxon Summary
        """
        pass

    async def test_observations_id_unfave_delete(self) -> None:
        """Test case for observations_id_unfave_delete

        Observations Unfave
        """
        pass

    async def test_observations_id_unreview_post(self) -> None:
        """Test case for observations_id_unreview_post

        Observations Unreview
        """
        pass

    async def test_observations_id_viewed_updates_put(self) -> None:
        """Test case for observations_id_viewed_updates_put

        Observation Field Value Update
        """
        pass

    async def test_observations_identifiers_get(self) -> None:
        """Test case for observations_identifiers_get

        Observation Identifiers
        """
        pass

    async def test_observations_observers_get(self) -> None:
        """Test case for observations_observers_get

        Observation Observers
        """
        pass

    async def test_observations_popular_field_values_get(self) -> None:
        """Test case for observations_popular_field_values_get

        Observation Popular Field Values
        """
        pass

    async def test_observations_post(self) -> None:
    ...
    async def test_observations_species_counts_get(self) -> None:
        """Test case for observations_species_counts_get

        Observation Species Counts
        """
        pass

    async def test_observations_updates_get(self) -> None:
        """Test case for observations_updates_get

        Observation User Updates
        """
        pass

    async def test_subscriptions_observation_id_subscribe_post(self) -> None:
        """Test case for subscriptions_observation_id_subscribe_post

        Observation Subscribe
        """
        pass

    async def test_votes_unvote_observation_id_delete(self) -> None:
        """Test case for votes_unvote_observation_id_delete

        Observation Unvote
        """
        pass

    async def test_votes_vote_observation_id_post(self) -> None:
        """Test case for votes_vote_observation_id_post

...
@unittest.skip("Skipping all tests in TestPolygonTilesApi")
class TestPolygonTilesApi(unittest.IsolatedAsyncioTestCase):
    """PolygonTilesApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = PolygonTilesApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_places_place_id_zoom_xy_png_get(self) -> None:
        """Test case for places_place_id_zoom_xy_png_get

        Place Tiles
        """
        pass

    async def test_taxon_places_taxon_id_zoom_xy_png_get(self) -> None:
        """Test case for taxon_places_taxon_id_zoom_xy_png_get

        Taxon Place Tiles
        """
        pass

    async def test_taxon_ranges_taxon_id_zoom_xy_png_get(self) -> None:
        """Test case for taxon_ranges_taxon_id_zoom_xy_png_get

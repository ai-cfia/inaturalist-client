...
@unittest.skip("Skipping all tests in TestUTFGridResponse")
class TestUTFGridResponse(unittest.TestCase):
    """UTFGridResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UTFGridResponse:
        """Test UTFGridResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UTFGridResponse`
        """
        model = UTFGridResponse()
        if include_optional:
            return UTFGridResponse(
                grid = [
                    ''
                    ],
                keys = [

...
@unittest.skip("Skipping all tests in TestShowObservation")
class TestShowObservation(unittest.TestCase):
    """ShowObservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowObservation:
        """Test ShowObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShowObservation`
        """
        model = ShowObservation()
        if include_optional:
            return ShowObservation(
                ...
                verifiable = True,
                identifications = [
                    inaturalist_client.models.identification.Identification(
                        id = 56, 
                        observation_id = 56, 
                        body = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                faves = [
                    inaturalist_client.models.fave.Fave(
                        id = 56, 
                        votable_id = 56, 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        user = inaturalist_client.models.user.User(

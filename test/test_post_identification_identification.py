...
@unittest.skip("Skipping all tests in TestPostIdentificationIdentification")
class TestPostIdentificationIdentification(unittest.TestCase):
    """PostIdentificationIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostIdentificationIdentification:
        """Test PostIdentificationIdentification
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostIdentificationIdentification`
        """
        model = PostIdentificationIdentification()
        if include_optional:
            return PostIdentificationIdentification(
                observation_id = 56,
                taxon_id = 56,
                current = True,
                body = ''
    ...
    def testPostIdentificationIdentification(self):
        """Test PostIdentificationIdentification"""

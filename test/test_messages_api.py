...
@unittest.skip("Skipping all tests in TestMessagesApi")
class TestMessagesApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_messages_get(self) -> None:
    ...
    async def test_messages_id_delete(self) -> None:
    ...
    async def test_messages_id_get(self) -> None:
    ...
    async def test_messages_post(self) -> None:
    ...
    async def test_messages_unread_get(self) -> None:
        """Test case for messages_unread_get

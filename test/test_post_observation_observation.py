...
@unittest.skip("Skipping all tests in TestPostObservationObservation")
class TestPostObservationObservation(unittest.TestCase):
    """PostObservationObservation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservationObservation:
        """Test PostObservationObservation
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationObservation`
        """
        model = PostObservationObservation()
        if include_optional:
            return PostObservationObservation(
                species_guess = '',
                taxon_id = 56,
                description = ''
            )
    ...
    def testPostObservationObservation(self):
        """Test PostObservationObservation"""

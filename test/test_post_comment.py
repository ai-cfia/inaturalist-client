...
@unittest.skip("Skipping all tests in TestPostComment")
class TestPostComment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostComment:
        """Test PostComment
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostComment`
        """
        model = PostComment()
        if include_optional:
            return PostComment(
                comment = inaturalist_client.models.post_comment_comment.PostComment_comment(

...
@unittest.skip("Skipping all tests in TestCorePlace")
class TestCorePlace(unittest.TestCase):
    """CorePlace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CorePlace:
        """Test CorePlace
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CorePlace`
        """
        model = CorePlace()
        if include_optional:
            return CorePlace(

...
@unittest.skip("Skipping all tests in TestPostObservationPhoto")
class TestPostObservationPhoto(unittest.TestCase):
    """PostObservationPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostObservationPhoto:
        """Test PostObservationPhoto
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostObservationPhoto`
        """
        model = PostObservationPhoto()
        if include_optional:
            return PostObservationPhoto(
                observation_photo = inaturalist_client.models.post_observation_photo_observation_photo.PostObservationPhoto_observation_photo(
                    observation_id = 56, )
            )
        else:
            return PostObservationPhoto(
    ...
    def testPostObservationPhoto(self):
        """Test PostObservationPhoto"""

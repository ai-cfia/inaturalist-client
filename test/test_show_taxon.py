...
@unittest.skip("Skipping all tests in TestShowTaxon")
class TestShowTaxon(unittest.TestCase):
    """ShowTaxon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShowTaxon:
        """Test ShowTaxon
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ShowTaxon`
        """
        model = ShowTaxon()
        if include_optional:
            return ShowTaxon(
                ...
                colors = [
                    inaturalist_client.models.color.Color(
                        id = 56, 
                        value = '', )
                    ],
                conservation_status = inaturalist_client.models.conservation_status.ConservationStatus(
                    place_id = 56, 

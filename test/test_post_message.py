...
@unittest.skip("Skipping all tests in TestPostMessage")
class TestPostMessage(unittest.TestCase):
    """PostMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostMessage:
        """Test PostMessage
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PostMessage`
        """
        model = PostMessage()
        if include_optional:
            return PostMessage(
                message = inaturalist_client.models.post_message_message.PostMessage_message(
                    to_user_id = 56, 
                    thread_id = 56, 
                    subject = '', 
                    body = '', )

...
@unittest.skip("Skipping all tests in TestObservationPhotosApi")
class TestObservationPhotosApi(unittest.IsolatedAsyncioTestCase):
    """ObservationPhotosApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ObservationPhotosApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_observation_photos_id_delete(self) -> None:
        """Test case for observation_photos_id_delete

        Observation Photo Delete
        """
        pass

    async def test_observation_photos_id_put(self) -> None:
        """Test case for observation_photos_id_put

        Observation Photo Update
        """
        pass

    async def test_observation_photos_post(self) -> None:
        """Test case for observation_photos_post

...
class UpdateProjectObservationProjectObservation(BaseModel):
    """
    ...
    prefers_curator_coordinate_access: Optional[StrictBool] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateProjectObservationProjectObservation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateProjectObservationProjectObservation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "prefers_curator_coordinate_access": obj.get(
                    "prefers_curator_coordinate_access"
                ),
            }
        )

...
class PostObservationVote(BaseModel):
    ...
    vote: Optional[StrictStr] = None
    scope: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vote", "scope"]
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(["needs_id"]):
            raise ValueError("must be one of enum values ('needs_id')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationVote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationVote from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"vote": obj.get("vote"), "scope": obj.get("scope")})
        return _obj

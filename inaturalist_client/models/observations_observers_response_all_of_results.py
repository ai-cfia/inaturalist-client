...
class ObservationsObserversResponseAllOfResults(BaseModel):
    """
    ObservationsObserversResponseAllOfResults
    """  # noqa: E501

    observation_count: Optional[StrictInt] = None
    species_count: Optional[StrictInt] = None
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["observation_count", "species_count", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ObservationsObserversResponseAllOfResults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ObservationsObserversResponseAllOfResults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "species_count": obj.get("species_count"),

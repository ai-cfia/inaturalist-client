...
class PostPost(BaseModel):
    ...
    post: Optional[PostPostPost] = None
    __properties: ClassVar[List[str]] = ["commit", "post"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostPost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "post": PostPostPost.from_dict(obj["post"])
                if obj.get("post") is not None
                else None,
            }
        )
        return _obj

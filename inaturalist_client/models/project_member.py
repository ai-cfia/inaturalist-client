...
class ProjectMember(BaseModel):
    ...
    taxa_count: Optional[StrictInt] = None
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(["curator", "manager"]):
            raise ValueError("must be one of enum values ('curator', 'manager')")
        return value

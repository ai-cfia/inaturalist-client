...
class PostUserUser(BaseModel):
    ...
    name: Optional[StrictStr] = Field(
        default=None, description="Display name for this user"
    )
    locale: Optional[StrictStr] = Field(
        default=None,
        description="Locale code for language/region localization. See https://github.com/inaturalist/inaturalist/tree/master/config/locales for available locales. Valid strings can be derived from file names, e.g. `es-MX` from `es-MX.yml`. ",
    )
    time_zone: Optional[StrictStr] = Field(
        default=None,
        description="Default time zone for the user's observations. See http://api.rubyonrails.org/classes/ActiveSupport/TimeZone.html for a list of values. ",
    )
    place_id: Optional[StrictInt] = Field(
        default=None,
        description="ID of the place for this user, customizes some common names and default search parameters ",
    )
    description: Optional[StrictStr] = Field(
        default=None, description="User profile description"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostUserUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostUserUser from a dict"""
        if obj is None:
            return None

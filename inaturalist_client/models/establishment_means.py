...
class EstablishmentMeans(BaseModel):
    ...
    establishment_means: Optional[StrictStr] = None
    place: Optional[CorePlace] = None
    __properties: ClassVar[List[str]] = ["establishment_means", "place"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EstablishmentMeans from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EstablishmentMeans from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "establishment_means": obj.get("establishment_means"),

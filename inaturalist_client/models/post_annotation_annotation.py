...
class PostAnnotationAnnotation(BaseModel):
    """
    ...
    controlled_attribute_id: Optional[StrictInt] = None
    controlled_value_id: Optional[StrictInt] = None
    ...
    def resource_type_validate_enum(cls, value):
        ...
        if value not in set(["Observation"]):
            raise ValueError("must be one of enum values ('Observation')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostAnnotationAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostAnnotationAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "controlled_attribute_id": obj.get("controlled_attribute_id"),
                "controlled_value_id": obj.get("controlled_value_id"),
            }
        )
        return _obj

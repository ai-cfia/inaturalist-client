...
class PostCommentComment(BaseModel):
    """
    PostCommentComment
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["parent_type", "parent_id", "body"]
    ...
    def parent_type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('Observation', 'ListedTaxon', 'AssessmentSection', 'ObservationField', 'Post', 'TaxonChange')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostCommentComment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostCommentComment from a dict"""
        if obj is None:
            return None

...
class ShowPlace(BaseModel):
    ...
    admin_level: Optional[StrictInt] = None
    ancestor_place_ids: Optional[List[StrictInt]] = None
    bbox_area: Optional[Union[StrictFloat, StrictInt]] = None
    geometry_geojson: Optional[PolygonGeoJson] = None
    location: Optional[StrictStr] = Field(
        default=None, description='in the format "lat,lng"'
    )
    place_type: Optional[StrictInt] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShowPlace from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of geometry_geojson
        if self.geometry_geojson:
            _dict["geometry_geojson"] = self.geometry_geojson.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShowPlace from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "admin_level": obj.get("admin_level"),
                "ancestor_place_ids": obj.get("ancestor_place_ids"),
                "bbox_area": obj.get("bbox_area"),
                "geometry_geojson": PolygonGeoJson.from_dict(obj["geometry_geojson"])
                if obj.get("geometry_geojson") is not None
                else None,

...
class SpeciesCountsResponseAllOfResults(BaseModel):
    """
    SpeciesCountsResponseAllOfResults
    """  # noqa: E501

    count: Optional[StrictInt] = None
    taxon: Optional[ShowTaxon] = None
    __properties: ClassVar[List[str]] = ["count", "taxon"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpeciesCountsResponseAllOfResults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpeciesCountsResponseAllOfResults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "count": obj.get("count"),
                "taxon": ShowTaxon.from_dict(obj["taxon"])

...
class PostObservationFieldValue(BaseModel):
    ...
    observation_field_value: Optional[
        PostObservationFieldValueObservationFieldValue
    ] = None
    __properties: ClassVar[List[str]] = ["observation_field_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationFieldValue from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of observation_field_value
        if self.observation_field_value:
            _dict["observation_field_value"] = self.observation_field_value.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationFieldValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "observation_field_value": PostObservationFieldValueObservationFieldValue.from_dict(
                    obj["observation_field_value"]
                )
                if obj.get("observation_field_value") is not None
                else None
            }
        )
        return _obj

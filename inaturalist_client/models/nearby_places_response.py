...
class NearbyPlacesResponse(BaseModel):
    ...
    results: NearbyPlacesResponseAllOfResults
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NearbyPlacesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NearbyPlacesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": NearbyPlacesResponseAllOfResults.from_dict(obj["results"])

...
class ShowTaxon(BaseModel):
    ...
    ancestor_ids: Optional[List[StrictInt]] = None
    colors: Optional[List[Color]] = None
    conservation_status: Optional[ConservationStatus] = None
    conservation_statuses: Optional[List[TaxonConservationStatus]] = None
    default_photo: Optional[TaxonPhoto] = None
    establishment_means: Optional[EstablishmentMeans] = None
    observations_count: Optional[StrictInt] = None
    preferred_establishment_means: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShowTaxon from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.colors:
            ...
            _dict["colors"] = _items
        # override the default output from pydantic by calling `to_dict()` of conservation_status
        if self.conservation_status:
            _dict["conservation_status"] = self.conservation_status.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in conservation_statuses (list)
        _items = []
        if self.conservation_statuses:
            for _item_conservation_statuses in self.conservation_statuses:
                if _item_conservation_statuses:
                    _items.append(_item_conservation_statuses.to_dict())
            _dict["conservation_statuses"] = _items
        ...
        # override the default output from pydantic by calling `to_dict()` of establishment_means
        if self.establishment_means:
            _dict["establishment_means"] = self.establishment_means.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShowTaxon from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "ancestor_ids": obj.get("ancestor_ids"),
                "colors": [Color.from_dict(_item) for _item in obj["colors"]]
                if obj.get("colors") is not None
                else None,
                "conservation_status": ConservationStatus.from_dict(
                    obj["conservation_status"]
                )
                if obj.get("conservation_status") is not None
                else None,
                "conservation_statuses": [
                    TaxonConservationStatus.from_dict(_item)
                    for _item in obj["conservation_statuses"]
                ]
                if obj.get("conservation_statuses") is not None
                else None,
                "default_photo": TaxonPhoto.from_dict(obj["default_photo"])
                if obj.get("default_photo") is not None
                else None,
                "establishment_means": EstablishmentMeans.from_dict(
                    obj["establishment_means"]
                )
                if obj.get("establishment_means") is not None
                else None,
                "observations_count": obj.get("observations_count"),
                "preferred_establishment_means": obj.get(
                    "preferred_establishment_means"
                ),
            }
        )

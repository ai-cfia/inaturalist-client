...
class PostObservationPhotoObservationPhoto(BaseModel):
    """
    PostObservationPhotoObservationPhoto
    """  # noqa: E501

    observation_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["observation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationPhotoObservationPhoto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationPhotoObservationPhoto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"observation_id": obj.get("observation_id")})
        return _obj

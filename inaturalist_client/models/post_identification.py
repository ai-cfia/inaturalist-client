...
class PostIdentification(BaseModel):
    ...
    identification: Optional[PostIdentificationIdentification] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostIdentification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostIdentification from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "identification": PostIdentificationIdentification.from_dict(
                    obj["identification"]
                )

...
class UserCountsResponse(BaseModel):
    ...
    results: List[UserCountsResponseAllOfResults]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserCountsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserCountsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    UserCountsResponseAllOfResults.from_dict(_item)

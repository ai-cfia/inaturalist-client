...
class PostFlagFlag(BaseModel):
    """
    PostFlagFlag
    """  # noqa: E501

    flaggable_type: Optional[StrictStr] = None
    flaggable_id: Optional[StrictInt] = None
    flag: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["flaggable_type", "flaggable_id", "flag"]

    @field_validator("flaggable_type")
    def flaggable_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(
            ["Comment", "Identification", "Message", "Observation", "Post", "Taxon"]
        ):
            raise ValueError(
                "must be one of enum values ('Comment', 'Identification', 'Message', 'Observation', 'Post', 'Taxon')"
            )
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostFlagFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostFlagFlag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "flaggable_type": obj.get("flaggable_type"),
                "flaggable_id": obj.get("flaggable_id"),
                "flag": obj.get("flag"),
            }
        )
        return _obj

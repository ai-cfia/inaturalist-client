...
class PostAnnotation(BaseModel):
    ...
    annotation: Optional[PostAnnotationAnnotation] = None
    __properties: ClassVar[List[str]] = ["annotation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostAnnotation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostAnnotation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "annotation": PostAnnotationAnnotation.from_dict(obj["annotation"])

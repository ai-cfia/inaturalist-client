...
class User(BaseModel):
    ...
    icon_content_type: Optional[StrictStr] = None
    icon_file_name: Optional[StrictStr] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "icon_content_type": obj.get("icon_content_type"),
                "icon_file_name": obj.get("icon_file_name"),
                "icon": obj.get("icon"),

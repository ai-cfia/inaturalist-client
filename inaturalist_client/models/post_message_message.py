...
class PostMessageMessage(BaseModel):
    """
    PostMessageMessage
    """  # noqa: E501

    to_user_id: Optional[StrictInt] = Field(
        default=None, description="User ID of the recipient"
    )
    thread_id: Optional[StrictInt] = Field(
        default=None,
        description="Identifier for the thread. Should be blank for new threads, but when replying to an existing message, it should be set to the thread_id of the message being replied to. ",
    )
    subject: Optional[StrictStr] = Field(
        default=None, description="Subject of the message"
    )
    body: Optional[StrictStr] = Field(default=None, description="Body of the message")
    __properties: ClassVar[List[str]] = ["to_user_id", "thread_id", "subject", "body"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMessageMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMessageMessage from a dict"""
        if obj is None:
            return None

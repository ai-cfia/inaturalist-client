...
class NearbyPlacesResponseAllOfResults(BaseModel):
    """
    NearbyPlacesResponseAllOfResults
    """  # noqa: E501

    standard: Optional[List[ShowPlace]] = None
    community: Optional[List[ShowPlace]] = None
    __properties: ClassVar[List[str]] = ["standard", "community"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NearbyPlacesResponseAllOfResults from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in community (list)
        _items = []
        if self.community:
            for _item_community in self.community:
                if _item_community:
                    _items.append(_item_community.to_dict())
            _dict["community"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NearbyPlacesResponseAllOfResults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "standard": [ShowPlace.from_dict(_item) for _item in obj["standard"]]
                if obj.get("standard") is not None
                else None,
                "community": [ShowPlace.from_dict(_item) for _item in obj["community"]]
                if obj.get("community") is not None
                else None,
            }
        )
        return _obj

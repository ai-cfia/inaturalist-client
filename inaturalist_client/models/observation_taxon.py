...
class ObservationTaxon(BaseModel):
    ...
    conservation_status: Optional[RawConservationStatus] = None
    endemic: Optional[StrictBool] = None
    establishment_means: Optional[EstablishmentMeans] = None
    introduced: Optional[StrictBool] = None
    native: Optional[StrictBool] = None
    threatened: Optional[StrictBool] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ObservationTaxon from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ObservationTaxon from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "conservation_status": RawConservationStatus.from_dict(
                    obj["conservation_status"]
                )
                if obj.get("conservation_status") is not None
                else None,
                "endemic": obj.get("endemic"),

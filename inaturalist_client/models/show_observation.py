...
class ShowObservation(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShowObservation from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in faves (list)
        _items = []
        if self.faves:
            for _item_faves in self.faves:
                if _item_faves:
                    _items.append(_item_faves.to_dict())
            _dict["faves"] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShowObservation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "identifications": [
                    Identification.from_dict(_item) for _item in obj["identifications"]
                ]
                if obj.get("identifications") is not None
                else None,
                "faves": [Fave.from_dict(_item) for _item in obj["faves"]]
                if obj.get("faves") is not None
                else None,
            }
        )
        return _obj

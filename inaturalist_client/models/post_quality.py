...
class PostQuality(BaseModel):
    ...
    agree: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["agree"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostQuality from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostQuality from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"agree": obj.get("agree")})
        return _obj

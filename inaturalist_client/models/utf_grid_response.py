...
class UTFGridResponse(BaseModel):
    ...
    grid: Optional[List[StrictStr]] = None
    keys: Optional[List[StrictStr]] = None
    data: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["grid", "keys", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UTFGridResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UTFGridResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"grid": obj.get("grid"), "keys": obj.get("keys"), "data": obj.get("data")}
        )
        return _obj

...
class PostObservationPhoto(BaseModel):
    ...
    observation_photo: Optional[PostObservationPhotoObservationPhoto] = None
    __properties: ClassVar[List[str]] = ["observation_photo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationPhoto from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of observation_photo
        if self.observation_photo:
            _dict["observation_photo"] = self.observation_photo.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationPhoto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "observation_photo": PostObservationPhotoObservationPhoto.from_dict(
                    obj["observation_photo"]
                )
                if obj.get("observation_photo") is not None
                else None
            }
        )
        return _obj

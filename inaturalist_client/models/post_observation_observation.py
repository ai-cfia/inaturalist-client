...
class PostObservationObservation(BaseModel):
    """
    PostObservationObservation
    """  # noqa: E501

    species_guess: Optional[StrictStr] = None
    taxon_id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["species_guess", "taxon_id", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationObservation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationObservation from a dict"""
        if obj is None:
            return None

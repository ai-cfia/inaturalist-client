...
class PostComment(BaseModel):
    ...
    comment: Optional[PostCommentComment] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostComment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostComment from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "comment": PostCommentComment.from_dict(obj["comment"])

...
class ConservationStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["place_id", "place", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConservationStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConservationStatus from a dict"""
        if obj is None:
            return None

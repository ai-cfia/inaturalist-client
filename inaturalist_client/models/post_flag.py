...
class PostFlag(BaseModel):
    ...
    flag: Optional[PostFlagFlag] = None
    flag_explanation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["flag", "flag_explanation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostFlag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "flag": PostFlagFlag.from_dict(obj["flag"])
                if obj.get("flag") is not None
                else None,
                "flag_explanation": obj.get("flag_explanation"),
            }
        )
        return _obj

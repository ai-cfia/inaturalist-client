...
class PostProjectObservation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["project_id", "observation_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostProjectObservation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostProjectObservation from a dict"""
        if obj is None:
            return None

...
class PostUserUpdateSession(BaseModel):
    ...
    preferred_taxon_page_ancestors_shown: Optional[StrictBool] = None
    preferred_taxon_page_place_id: Optional[StrictInt] = None
    preferred_taxon_page_tab: Optional[StrictStr] = None
    prefers_skip_coarer_id_modal: Optional[StrictBool] = None
    prefers_hide_obs_show_annotations: Optional[StrictBool] = None
    prefers_hide_obs_show_projects: Optional[StrictBool] = None
    prefers_hide_obs_show_tags: Optional[StrictBool] = None
    prefers_hide_obs_show_observation_fields: Optional[StrictBool] = None
    prefers_hide_obs_show_identifiers: Optional[StrictBool] = None
    prefers_hide_obs_show_copyright: Optional[StrictBool] = None
    prefers_hide_obs_show_quality_metrics: Optional[StrictBool] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostUserUpdateSession from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostUserUpdateSession from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "preferred_taxon_page_ancestors_shown": obj.get(
                    "preferred_taxon_page_ancestors_shown"
                ),
                "preferred_taxon_page_place_id": obj.get(
                    "preferred_taxon_page_place_id"
                ),
                "preferred_taxon_page_tab": obj.get("preferred_taxon_page_tab"),
                "prefers_skip_coarer_id_modal": obj.get("prefers_skip_coarer_id_modal"),
                "prefers_hide_obs_show_annotations": obj.get(
                    "prefers_hide_obs_show_annotations"
                ),
                "prefers_hide_obs_show_projects": obj.get(
                    "prefers_hide_obs_show_projects"
                ),
                "prefers_hide_obs_show_tags": obj.get("prefers_hide_obs_show_tags"),
                "prefers_hide_obs_show_observation_fields": obj.get(
                    "prefers_hide_obs_show_observation_fields"
                ),
                "prefers_hide_obs_show_identifiers": obj.get(
                    "prefers_hide_obs_show_identifiers"
                ),
                "prefers_hide_obs_show_copyright": obj.get(
                    "prefers_hide_obs_show_copyright"
                ),
                "prefers_hide_obs_show_quality_metrics": obj.get(
                    "prefers_hide_obs_show_quality_metrics"
                ),
            }
        )

...
class Fave(BaseModel):
    ...
    votable_id: Optional[StrictInt] = None
    created_at: Optional[datetime] = None
    user: Optional[User] = None
    __properties: ClassVar[List[str]] = ["id", "votable_id", "created_at", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Fave from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Fave from a dict"""
        if obj is None:
            return None

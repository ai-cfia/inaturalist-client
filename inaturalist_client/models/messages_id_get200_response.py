...
class MessagesIdGet200Response(BaseModel):
    """
    ...
    thread_id: Optional[StrictInt] = Field(
        default=None, description="Identifier for this thread"
    )
    flaggable_message_id: Optional[StrictInt] = Field(
        default=None,
        description="Identifier for the message that should be flagged if the user chooses to flag this thread ",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessagesIdGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessagesIdGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "reply_to_user": User.from_dict(obj["reply_to_user"])
                if obj.get("reply_to_user") is not None
                else None,
                "thread_id": obj.get("thread_id"),
                "flaggable_message_id": obj.get("flaggable_message_id"),
                "results": [Message.from_dict(_item) for _item in obj["results"]]

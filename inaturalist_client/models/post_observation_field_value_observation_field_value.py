...
class PostObservationFieldValueObservationFieldValue(BaseModel):
    """
    PostObservationFieldValueObservationFieldValue
    """  # noqa: E501

    observation_id: Optional[StrictInt] = None
    observation_field_id: Optional[StrictInt] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservationFieldValueObservationFieldValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservationFieldValueObservationFieldValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "observation_field_id": obj.get("observation_field_id"),
                "value": obj.get("value"),
            }
        )
        return _obj

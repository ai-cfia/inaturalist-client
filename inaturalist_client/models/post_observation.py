...
class PostObservation(BaseModel):
    ...
    observation: Optional[PostObservationObservation] = None
    __properties: ClassVar[List[str]] = ["observation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostObservation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostObservation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "observation": PostObservationObservation.from_dict(obj["observation"])
                if obj.get("observation") is not None
                else None
            }
        )
        return _obj

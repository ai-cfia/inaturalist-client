...
class PostPostPost(BaseModel):
    ...
    preferred_formatting: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostPostPost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostPostPost from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "title": obj.get("title"),
                "body": obj.get("body"),
                "preferred_formatting": obj.get("preferred_formatting"),

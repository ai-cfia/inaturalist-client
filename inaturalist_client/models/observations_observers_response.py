...
class ObservationsObserversResponse(BaseModel):
    ...
    results: List[ObservationsObserversResponseAllOfResults]
    __properties: ClassVar[List[str]] = ["total_results", "page", "per_page", "results"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ObservationsObserversResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ObservationsObserversResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    ObservationsObserversResponseAllOfResults.from_dict(_item)

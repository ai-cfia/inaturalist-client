...
class UpdateProjectObservation(BaseModel):
    ...
    project_observation: Optional[UpdateProjectObservationProjectObservation] = None
    __properties: ClassVar[List[str]] = ["project_observation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateProjectObservation from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of project_observation
        if self.project_observation:
            _dict["project_observation"] = self.project_observation.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateProjectObservation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "project_observation": UpdateProjectObservationProjectObservation.from_dict(
                    obj["project_observation"]
                )
                if obj.get("project_observation") is not None
                else None
            }
        )
        return _obj

...
class PutFlagFlag(BaseModel):
    """
    PutFlagFlag
    """  # noqa: E501

    resolved: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["resolved"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutFlagFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutFlagFlag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"resolved": obj.get("resolved")})
        return _obj

...
class TaxonPhoto(BaseModel):
    ...
    medium_url: Optional[StrictStr] = None
    square_url: Optional[StrictStr] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaxonPhoto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaxonPhoto from a dict"""
        if obj is None:
            return None

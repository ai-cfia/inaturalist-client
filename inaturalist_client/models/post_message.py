...
class PostMessage(BaseModel):
    ...
    message: Optional[PostMessageMessage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "message": PostMessageMessage.from_dict(obj["message"])

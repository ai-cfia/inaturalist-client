...
class PutFlag(BaseModel):
    ...
    flag: Optional[PutFlagFlag] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutFlag from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutFlag from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "flag": PutFlagFlag.from_dict(obj["flag"])

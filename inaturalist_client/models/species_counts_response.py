...
class SpeciesCountsResponse(BaseModel):
    ...
    results: List[SpeciesCountsResponseAllOfResults]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpeciesCountsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpeciesCountsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": [
                    SpeciesCountsResponseAllOfResults.from_dict(_item)

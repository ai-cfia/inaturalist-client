...
class ObservationPhotosApi:
    ...
    @validate_call
    async def observation_photos_id_delete(
        self,
        ...
        _param = self._observation_photos_id_delete_serialize(
            id=id,
    ...
    @validate_call
    async def observation_photos_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def observation_photos_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _observation_photos_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/observation_photos/{id}",
    ...
    @validate_call
    async def observation_photos_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        observation_photo_position: Annotated[
            Optional[StrictInt],
            Field(
        ...
        :param id: ID of the record (required)
        :type id: int
        :param observation_photo_position: Position in which the photo is displayed for the observation
        :type observation_photo_position: int
        ...
        _param = self._observation_photos_id_put_serialize(
            id=id,
            observation_photo_position=observation_photo_position,
            file=file,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def observation_photos_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        observation_photo_position: Annotated[
            Optional[StrictInt],
    ...
    @validate_call
    async def observation_photos_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        observation_photo_position: Annotated[
            Optional[StrictInt],
    ...
    def _observation_photos_id_put_serialize(
        self,
        id,
        observation_photo_position,
        file,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the header parameters
        # process the form parameters
        if observation_photo_position is not None:
            _form_params.append(
                ("observation_photo[position]", observation_photo_position)
            )
        if file is not None:
            _files["file"] = file
        # process the body parameter
    ...
    @validate_call
    async def observation_photos_post(
        self,
        observation_photo_observation_id: Annotated[
            Optional[StrictInt], Field(description="Observation ID")
        ] = None,
        observation_photo_uuid: Annotated[
            Optional[StrictStr], Field(description="Observation UUID")
        ] = None,
        file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(description="The photo"),
        ...
        :param observation_photo_observation_id: Observation ID
        :type observation_photo_observation_id: int
        :param observation_photo_uuid: Observation UUID
        :type observation_photo_uuid: str
        :param file: The photo
        :type file: bytearray
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._observation_photos_post_serialize(
            observation_photo_observation_id=observation_photo_observation_id,
            observation_photo_uuid=observation_photo_uuid,
            file=file,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def observation_photos_post_with_http_info(
        self,
        observation_photo_observation_id: Annotated[
            Optional[StrictInt], Field(description="Observation ID")
        ] = None,
    ...
    @validate_call
    async def observation_photos_post_without_preload_content(
        self,
        observation_photo_observation_id: Annotated[
            Optional[StrictInt], Field(description="Observation ID")
        ] = None,
    ...
    def _observation_photos_post_serialize(
        self,
        observation_photo_observation_id,
        observation_photo_uuid,
        file,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the header parameters
        # process the form parameters
        if observation_photo_observation_id is not None:
            _form_params.append(
                ("observation_photo[observation_id]", observation_photo_observation_id)
            )
        if observation_photo_uuid is not None:
            _form_params.append(("observation_photo[uuid]", observation_photo_uuid))
        if file is not None:
            _files["file"] = file
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/observation_photos",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

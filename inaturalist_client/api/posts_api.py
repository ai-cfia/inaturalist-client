...
class PostsApi:
    ...
    @validate_call
    async def posts_for_user_get(
        self,
        newer_than: Annotated[
            Optional[datetime],
            Field(description="returns posts newer than the post with this ID"),
        ] = None,
        older_than: Annotated[
            Optional[datetime],
            Field(description="returns posts older than the post with this ID"),
        ] = None,
        page: Annotated[
        ...
        :param newer_than: returns posts newer than the post with this ID
        :type newer_than: datetime
        :param older_than: returns posts older than the post with this ID
        ...
        _param = self._posts_for_user_get_serialize(
    ...
    @validate_call
    async def posts_for_user_get_with_http_info(
        self,
        newer_than: Annotated[
            Optional[datetime],
            Field(description="returns posts newer than the post with this ID"),
    ...
    @validate_call
    async def posts_for_user_get_without_preload_content(
        self,
        newer_than: Annotated[
            Optional[datetime],
            Field(description="returns posts newer than the post with this ID"),
    ...
    def _posts_for_user_get_serialize(
        self,
        newer_than,
        older_than,
        page,
        ...
        if newer_than is not None:
            if isinstance(newer_than, datetime):
                ...
                _query_params.append(("newer_than", newer_than))
    ...
    async def posts_get(
        self,
        login: Annotated[
            Optional[StrictStr], Field(description="Return posts by this user")
        ] = None,
        project_id: Annotated[
            Optional[StrictInt], Field(description="Return posts from this project")
        ] = None,
        page: Annotated[
            Optional[StrictStr], Field(description="Pagination `page` number")
        ] = None,
        ...
        :param login: Return posts by this user
        :type login: str
        :param project_id: Return posts from this project
        :type project_id: int
        :param page: Pagination `page` number
        :type page: str
        ...
        _param = self._posts_get_serialize(
            login=login,
    ...
    @validate_call
    async def posts_get_with_http_info(
        self,
        login: Annotated[
            Optional[StrictStr], Field(description="Return posts by this user")
        ] = None,
    ...
    @validate_call
    async def posts_get_without_preload_content(
        self,
        login: Annotated[
            Optional[StrictStr], Field(description="Return posts by this user")
        ] = None,
    ...
    async def posts_id_delete(
        ...
        _param = self._posts_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def posts_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def posts_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _posts_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def posts_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[Optional[PostPost], Field(description="Post object")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._posts_id_put_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def posts_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[Optional[PostPost], Field(description="Post object")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def posts_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[Optional[PostPost], Field(description="Post object")] = None,
        _request_timeout: Union[
    ...
    async def posts_post(
        ...
        _param = self._posts_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def posts_post_with_http_info(
        self,
        body: Annotated[Optional[PostPost], Field(description="Post object")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def posts_post_without_preload_content(
        self,
        body: Annotated[Optional[PostPost], Field(description="Post object")] = None,
        _request_timeout: Union[
            None,

...
class ObservationFieldValuesApi:
    ...
    @validate_call
    async def observation_field_values_id_delete(
        self,
        ...
        _param = self._observation_field_values_id_delete_serialize(
            id=id,
    ...
    @validate_call
    async def observation_field_values_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def observation_field_values_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _observation_field_values_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/observation_field_values/{id}",
    ...
    @validate_call
    async def observation_field_values_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostObservationFieldValue],
            Field(description="Observation field value object"),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: ID of the record (required)
        :type id: int
        :param body: Observation field value object
        :type body: PostObservationFieldValue
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._observation_field_values_id_put_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def observation_field_values_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostObservationFieldValue],
    ...
    @validate_call
    async def observation_field_values_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostObservationFieldValue],
    ...
    def _observation_field_values_id_put_serialize(
        self,
        id,
        body,
        _request_auth,
    ...
    @validate_call
    async def observation_field_values_post(
        self,
        body: Annotated[
            Optional[PostObservationFieldValue],
            Field(description="Observation field value object"),
        ...
        _param = self._observation_field_values_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def observation_field_values_post_with_http_info(
        self,
        body: Annotated[
            Optional[PostObservationFieldValue],
            Field(description="Observation field value object"),
    ...
    @validate_call
    async def observation_field_values_post_without_preload_content(
        self,
        body: Annotated[
            Optional[PostObservationFieldValue],
            Field(description="Observation field value object"),
    ...
    def _observation_field_values_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/observation_field_values",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

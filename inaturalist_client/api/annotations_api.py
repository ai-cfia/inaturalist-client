...
class AnnotationsApi:
    ...
    @validate_call
    async def annotations_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        ...
        :param id: ID or UUID of the annotation (required)
        :type id: str
    ...
    @validate_call
    async def annotations_id_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def annotations_id_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def annotations_post(
        self,
        body: Annotated[
            Optional[PostAnnotation], Field(description="Annotation object")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param body: Annotation object
        :type body: PostAnnotation
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    @validate_call
    async def annotations_post_with_http_info(
        self,
        body: Annotated[
            Optional[PostAnnotation], Field(description="Annotation object")
        ] = None,
    ...
    @validate_call
    async def annotations_post_without_preload_content(
        self,
        body: Annotated[
            Optional[PostAnnotation], Field(description="Annotation object")
        ] = None,
    ...
    @validate_call
    async def votes_unvote_annotation_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        _request_timeout: Union[
            None,
        ...
        _param = self._votes_unvote_annotation_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def votes_unvote_annotation_id_delete_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def votes_unvote_annotation_id_delete_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        _request_timeout: Union[
            None,
    ...
    def _votes_unvote_annotation_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/votes/unvote/annotation/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def votes_vote_annotation_id_post(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        body: Annotated[Optional[PostVote], Field(description="Vote object")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._votes_vote_annotation_id_post_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def votes_vote_annotation_id_post_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        body: Annotated[Optional[PostVote], Field(description="Vote object")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def votes_vote_annotation_id_post_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID or UUID of the annotation")],
        body: Annotated[Optional[PostVote], Field(description="Vote object")] = None,
        _request_timeout: Union[
    ...
    def _votes_vote_annotation_id_post_serialize(
        self,
        id,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/votes/vote/annotation/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

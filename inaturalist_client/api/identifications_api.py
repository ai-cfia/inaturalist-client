...
class IdentificationsApi:
    ...
    @validate_call
    async def identifications_categories_get(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
        ] = None,
        own_observation: Annotated[
            Optional[StrictBool], Field(description="ID was added by the observer")
        ] = None,
        is_change: Annotated[
            Optional[StrictBool],
            Field(description="ID was created as a results of a taxon change"),
        ] = None,
        taxon_active: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is currently an active taxon"),
        ] = None,
        observation_taxon_active: Annotated[
            Optional[StrictBool],
            Field(description="Observation's taxon is currently an active taxon"),
        ] = None,
        id: Annotated[
            Optional[List[StrictInt]], Field(description="Identification ID")
        ] = None,
        rank: Annotated[
            Optional[List[StrictStr]],
            Field(description="ID's taxon must have this rank"),
        ] = None,
        observation_rank: Annotated[
            Optional[List[StrictStr]],
            Field(description="Observation's taxon must have this rank"),
        ] = None,
        user_id: Annotated[
            Optional[List[StrictInt]],
            Field(description="Identifier must have this user ID"),
        ] = None,
        user_login: Annotated[
            Optional[List[StrictStr]],
            Field(description="Identifier must have this login"),
        ] = None,
        current: Annotated[
            Optional[StrictBool],
            Field(description="Most recent ID on a observation by a user"),
        ] = None,
        category: Annotated[
            Optional[List[StrictStr]], Field(description="Type of identification")
        ] = None,
        place_id: Annotated[
            Optional[List[StrictStr]],
            Field(description="Observation must occur in this place"),
        ] = None,
        quality_grade: Annotated[
            Optional[List[StrictStr]],
            Field(description="Observation must have this quality grade"),
        ] = None,
        taxon_id: Annotated[
            Optional[List[StrictStr]],
            Field(description="ID taxa must match the given taxa or their descendants"),
        ] = None,
        observation_taxon_id: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="Observation taxa must match the given taxa or their descendants"
            ),
        ] = None,
        iconic_taxon_id: Annotated[
            Optional[List[StrictStr]], Field(description="ID iconic taxon ID")
        ] = None,
        observation_iconic_taxon_id: Annotated[
            Optional[List[StrictStr]], Field(description="Observation iconic taxon ID")
        ] = None,
        lrank: Annotated[
            Optional[StrictStr],
            Field(description="ID taxon must have this rank or higher"),
        ] = None,
        hrank: Annotated[
            Optional[StrictStr],
            Field(description="ID taxon must have this rank or lower"),
        ] = None,
        observation_lrank: Annotated[
            Optional[StrictStr],
            Field(description="Observation taxon must have this rank or higher"),
        ] = None,
        observation_hrank: Annotated[
            Optional[StrictStr],
            Field(description="Observation taxon must have this rank or lower"),
        ] = None,
        without_taxon_id: Annotated[
            Optional[List[StrictStr]],
            Field(description="Exclude IDs of these taxa and their descendants"),
        ] = None,
        without_observation_taxon_id: Annotated[
            Optional[List[StrictStr]],
            Field(
        ...
        d1: Annotated[
            Optional[date], Field(description="ID created on or after this time")
        ] = None,
        d2: Annotated[
            Optional[date], Field(description="ID created on or before this time")
        ] = None,
        observation_created_d1: Annotated[
            Optional[date],
            Field(description="Observation created on or after this date"),
        ] = None,
        observation_created_d2: Annotated[
            Optional[date],
            Field(description="Observation created on or before this date"),
        ] = None,
        observed_d1: Annotated[
            Optional[date],
            Field(description="Observation observed on or after this date"),
        ] = None,
        observed_d2: Annotated[
            Optional[date],
            Field(description="Observation observed on or before this date"),
        ] = None,
        id_above: Annotated[
        ...
        :param current_taxon: ID's taxon is the same it's observation's taxon
        :type current_taxon: bool
        :param own_observation: ID was added by the observer
        :type own_observation: bool
        :param is_change: ID was created as a results of a taxon change
        :type is_change: bool
        :param taxon_active: ID's taxon is currently an active taxon
        :type taxon_active: bool
        :param observation_taxon_active: Observation's taxon is currently an active taxon
        :type observation_taxon_active: bool
        :param id: Identification ID
        :type id: List[int]
        :param rank: ID's taxon must have this rank
        :type rank: List[str]
        :param observation_rank: Observation's taxon must have this rank
        :type observation_rank: List[str]
        :param user_id: Identifier must have this user ID
        :type user_id: List[int]
        :param user_login: Identifier must have this login
        :type user_login: List[str]
        :param current: Most recent ID on a observation by a user
        :type current: bool
        :param category: Type of identification
        :type category: List[str]
        :param place_id: Observation must occur in this place
        :type place_id: List[str]
        :param quality_grade: Observation must have this quality grade
        :type quality_grade: List[str]
        :param taxon_id: ID taxa must match the given taxa or their descendants
        :type taxon_id: List[str]
        :param observation_taxon_id: Observation taxa must match the given taxa or their descendants
        :type observation_taxon_id: List[str]
        :param iconic_taxon_id: ID iconic taxon ID
        :type iconic_taxon_id: List[str]
        :param observation_iconic_taxon_id: Observation iconic taxon ID
        :type observation_iconic_taxon_id: List[str]
        :param lrank: ID taxon must have this rank or higher
        :type lrank: str
        :param hrank: ID taxon must have this rank or lower
        :type hrank: str
        :param observation_lrank: Observation taxon must have this rank or higher
        :type observation_lrank: str
        :param observation_hrank: Observation taxon must have this rank or lower
        :type observation_hrank: str
        :param without_taxon_id: Exclude IDs of these taxa and their descendants
        :type without_taxon_id: List[str]
        :param without_observation_taxon_id: Exclude IDs of observations of these taxa and their descendants
        :type without_observation_taxon_id: List[str]
        :param d1: ID created on or after this time
        :type d1: date
        :param d2: ID created on or before this time
        :type d2: date
        :param observation_created_d1: Observation created on or after this date
        :type observation_created_d1: date
        :param observation_created_d2: Observation created on or before this date
        :type observation_created_d2: date
        :param observed_d1: Observation observed on or after this date
        :type observed_d1: date
        :param observed_d2: Observation observed on or before this date
        :type observed_d2: date
        ...
        _param = self._identifications_categories_get_serialize(
            ...
            lrank=lrank,
            hrank=hrank,
            observation_lrank=observation_lrank,
            observation_hrank=observation_hrank,
            without_taxon_id=without_taxon_id,
            without_observation_taxon_id=without_observation_taxon_id,
            d1=d1,
            d2=d2,
            observation_created_d1=observation_created_d1,
            observation_created_d2=observation_created_d2,
            observed_d1=observed_d1,
            observed_d2=observed_d2,
            id_above=id_above,
            id_below=id_below,
            page=page,
            per_page=per_page,
    ...
    @validate_call
    async def identifications_categories_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_categories_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_categories_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
        ...
        _collection_formats: Dict[str, str] = {
            ...
            "quality_grade": "csv",
            "taxon_id": "csv",
            "observation_taxon_id": "csv",
            "iconic_taxon_id": "csv",
            "observation_iconic_taxon_id": "csv",
            "without_taxon_id": "csv",
            "without_observation_taxon_id": "csv",
        }
        ...
        if current_taxon is not None:
            _query_params.append(("current_taxon", current_taxon))

        if own_observation is not None:
            _query_params.append(("own_observation", own_observation))

        if is_change is not None:
            _query_params.append(("is_change", is_change))

        if taxon_active is not None:
            _query_params.append(("taxon_active", taxon_active))

        if observation_taxon_active is not None:
            _query_params.append(("observation_taxon_active", observation_taxon_active))
        ...
        if observation_rank is not None:
            _query_params.append(("observation_rank", observation_rank))
        ...
        if observation_taxon_id is not None:
            _query_params.append(("observation_taxon_id", observation_taxon_id))

        if iconic_taxon_id is not None:
            _query_params.append(("iconic_taxon_id", iconic_taxon_id))

        if observation_iconic_taxon_id is not None:
        ...
        if observation_lrank is not None:
            _query_params.append(("observation_lrank", observation_lrank))

        if observation_hrank is not None:
            _query_params.append(("observation_hrank", observation_hrank))

        if without_taxon_id is not None:
            _query_params.append(("without_taxon_id", without_taxon_id))

        if without_observation_taxon_id is not None:
            _query_params.append(
                ("without_observation_taxon_id", without_observation_taxon_id)
            )
        ...
        if observation_created_d1 is not None:
            if isinstance(observation_created_d1, date):
                _query_params.append(
                    (
                        "observation_created_d1",
                        observation_created_d1.strftime(
                            self.api_client.configuration.date_format
                        ),
                    )
                )
            else:
                _query_params.append(("observation_created_d1", observation_created_d1))

        if observation_created_d2 is not None:
            if isinstance(observation_created_d2, date):
                _query_params.append(
                    (
                        "observation_created_d2",
                        observation_created_d2.strftime(
                            self.api_client.configuration.date_format
                        ),
                    )
                )
            else:
                _query_params.append(("observation_created_d2", observation_created_d2))

        if observed_d1 is not None:
            if isinstance(observed_d1, date):
                _query_params.append(
                    (
                        "observed_d1",
                        observed_d1.strftime(self.api_client.configuration.date_format),
                    )
                )
            else:
                _query_params.append(("observed_d1", observed_d1))

        if observed_d2 is not None:
            if isinstance(observed_d2, date):
                _query_params.append(
                    (
                        "observed_d2",
                        observed_d2.strftime(self.api_client.configuration.date_format),
                    )
                )
            else:
                _query_params.append(("observed_d2", observed_d2))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/categories",
    ...
    async def identifications_get(
        ...
        _param = self._identifications_get_serialize(
            current_taxon=current_taxon,
            own_observation=own_observation,
            is_change=is_change,
            taxon_active=taxon_active,
    ...
    @validate_call
    async def identifications_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
    ...
    @validate_call
    async def identifications_id_delete(
        self,
        ...
        _param = self._identifications_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def identifications_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def identifications_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _identifications_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/identifications/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def identifications_id_get(
        self,
        ...
        _param = self._identifications_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def identifications_id_get_with_http_info(
        self,
        id: Annotated[List[StrictInt], Field(description="Must have this ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def identifications_id_get_without_preload_content(
        self,
        id: Annotated[List[StrictInt], Field(description="Must have this ID")],
        _request_timeout: Union[
            None,
    ...
    def _identifications_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def identifications_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param id: ID of the record (required)
        :type id: int
        :param body: Identification object
        :type body: PostIdentification
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._identifications_id_put_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def identifications_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
    ...
    @validate_call
    async def identifications_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
    ...
    def _identifications_id_put_serialize(
        self,
        id,
        body,
        _request_auth,
    ...
    @validate_call
    async def identifications_identifiers_get(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
        ...
        _param = self._identifications_identifiers_get_serialize(
            current_taxon=current_taxon,
            own_observation=own_observation,
            is_change=is_change,
            taxon_active=taxon_active,
    ...
    @validate_call
    async def identifications_identifiers_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_identifiers_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_identifiers_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/identifiers",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def identifications_observers_get(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
        ...
        _param = self._identifications_observers_get_serialize(
            current_taxon=current_taxon,
            own_observation=own_observation,
            is_change=is_change,
            taxon_active=taxon_active,
    ...
    @validate_call
    async def identifications_observers_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_observers_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_observers_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/observers",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def identifications_post(
        self,
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
        ] = None,
        ...
        _param = self._identifications_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def identifications_post_with_http_info(
        self,
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
        ] = None,
    ...
    @validate_call
    async def identifications_post_without_preload_content(
        self,
        body: Annotated[
            Optional[PostIdentification], Field(description="Identification object")
        ] = None,
    ...
    def _identifications_post_serialize(
        self,
        body,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def identifications_recent_taxa_get(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
        ...
        _param = self._identifications_recent_taxa_get_serialize(
            current_taxon=current_taxon,
            own_observation=own_observation,
            is_change=is_change,
            taxon_active=taxon_active,
    ...
    @validate_call
    async def identifications_recent_taxa_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_recent_taxa_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_recent_taxa_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/recent_taxa",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def identifications_similar_species_get(
        self,
        taxon_id: Annotated[
            int,
            Field(
        ...
        :param taxon_id: Only show observations of these taxa and their descendants (required)
        :type taxon_id: int
        ...
        _param = self._identifications_similar_species_get_serialize(
            taxon_id=taxon_id,
            acc=acc,
            captive=captive,
            endemic=endemic,
    ...
    @validate_call
    async def identifications_similar_species_get_with_http_info(
        self,
        taxon_id: Annotated[
            int,
            Field(
    ...
    @validate_call
    async def identifications_similar_species_get_without_preload_content(
        self,
        taxon_id: Annotated[
            int,
            Field(
    ...
    def _identifications_similar_species_get_serialize(
        self,
        taxon_id,
        acc,
        captive,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/similar_species",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def identifications_species_counts_get(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
        ...
        taxon_of: Annotated[
            Optional[StrictStr], Field(description="Source of the taxon for counting")
        ] = None,
        order: Annotated[Optional[StrictStr], Field(description="Sort order")] = None,
        _request_timeout: Union[
            None,
        ...
        :param only_id: Return only the record IDs
        :type only_id: bool
        :param taxon_of: Source of the taxon for counting
        :type taxon_of: str
        :param order: Sort order
        :type order: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._identifications_species_counts_get_serialize(
            current_taxon=current_taxon,
            own_observation=own_observation,
            is_change=is_change,
            taxon_active=taxon_active,
    ...
    @validate_call
    async def identifications_species_counts_get_with_http_info(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    @validate_call
    async def identifications_species_counts_get_without_preload_content(
        self,
        current_taxon: Annotated[
            Optional[StrictBool],
            Field(description="ID's taxon is the same it's observation's taxon"),
    ...
    def _identifications_species_counts_get_serialize(
        self,
        current_taxon,
        own_observation,
        is_change,
        ...
        if taxon_of is not None:
            _query_params.append(("taxon_of", taxon_of))
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/identifications/species_counts",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
class FlagsApi:
    ...
    async def flags_id_delete(
        ...
        _param = self._flags_id_delete_serialize(
            id=id,
    ...
    @validate_call
    async def flags_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def flags_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _flags_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def flags_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Optional[PutFlag] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._flags_id_put_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def flags_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Optional[PutFlag] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def flags_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Optional[PutFlag] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def flags_post(
        self,
        body: Annotated[Optional[PostFlag], Field(description="Flag object")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._flags_post_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def flags_post_with_http_info(
        self,
        body: Annotated[Optional[PostFlag], Field(description="Flag object")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def flags_post_without_preload_content(
        self,
        body: Annotated[Optional[PostFlag], Field(description="Flag object")] = None,
        _request_timeout: Union[
            None,

...
class CommentsApi:
    ...
    @validate_call
    async def comments_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def comments_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def comments_id_put(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostComment], Field(description="Comment object")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._comments_id_put_serialize(
            id=id,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def comments_id_put_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostComment], Field(description="Comment object")
    ...
    @validate_call
    async def comments_id_put_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        body: Annotated[
            Optional[PostComment], Field(description="Comment object")
    ...
    def _comments_id_put_serialize(
        self,
        id,
        body,
        _request_auth,
    ...
    @validate_call
    async def comments_post_with_http_info(
        self,
        body: Annotated[
            Optional[PostComment], Field(description="Comment object")
        ] = None,
    ...
    @validate_call
    async def comments_post_without_preload_content(
        self,
        body: Annotated[
            Optional[PostComment], Field(description="Comment object")
        ] = None,

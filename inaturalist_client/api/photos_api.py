...
class PhotosApi:
    ...
    async def photos_post(
        ...
        _param = self._photos_post_serialize(
            file=file,
    ...
    @validate_call
    async def photos_post_with_http_info(
        self,
        file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(description="The photo"),
    ...
    @validate_call
    async def photos_post_without_preload_content(
        self,
        file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(description="The photo"),

...
class MessagesApi:
    ...
    async def messages_get(
        ...
        q: Annotated[
            Optional[StrictStr], Field(description="Search query for subject and body")
        ] = None,
        user_id: Annotated[
            Optional[StrictStr],
            Field(description="User ID or username of correspondent to filter by"),
        ] = None,
        threads: Annotated[
            Optional[StrictBool],
            Field(
                description="Groups results by `thread_id`, only shows the latest message per thread, and includes a `thread_messages_count` attribute showing the total number of messages in that thread. Note that this will not work with the `q` param, and it probably should only be used with `box=any` because the `thread_messages_count` will be inaccurate when you restrict it to `inbox` or `sent`. "
            ),
        ] = None,
        ...
        :type page: str
        :param box: Whether to view messages the user has received (default) or messages the user has sent
        :type box: str
        :param q: Search query for subject and body
        :type q: str
        :param user_id: User ID or username of correspondent to filter by
        :type user_id: str
        :param threads: Groups results by `thread_id`, only shows the latest message per thread, and includes a `thread_messages_count` attribute showing the total number of messages in that thread. Note that this will not work with the `q` param, and it probably should only be used with `box=any` because the `thread_messages_count` will be inaccurate when you restrict it to `inbox` or `sent`.
        :type threads: bool
    ...
    @validate_call
    async def messages_get_with_http_info(
        self,
        page: Annotated[
            Optional[StrictStr], Field(description="Pagination `page` number")
        ] = None,
    ...
    @validate_call
    async def messages_get_without_preload_content(
        self,
        page: Annotated[
            Optional[StrictStr], Field(description="Pagination `page` number")
        ] = None,
    ...
    def _messages_get_serialize(
        ...
        if threads is not None:
            _query_params.append(("threads", threads))
    ...
    async def messages_id_delete(
        ...
        _param = self._messages_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def messages_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def messages_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    def _messages_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def messages_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MessagesIdGet200Response]:
        """Retrieve messages in a thread
    ...
    @validate_call
    async def messages_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID of the record")],
        _request_timeout: Union[
            None,
    ...
    async def messages_post(
        self,
        body: Optional[PostMessage] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    async def messages_post_with_http_info(
        self,
        body: Optional[PostMessage] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def messages_post_without_preload_content(
        self,
        body: Optional[PostMessage] = None,
        _request_timeout: Union[
            None,
    ...
    async def messages_unread_get(
        ...
        _param = self._messages_unread_get_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "MessagesUnreadGet200Response",
        }
        response_data = await self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
        )
    ...
    @validate_call
    async def messages_unread_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MessagesUnreadGet200Response]:
        """Gets a count of messages the authenticated user has not read
    ...
    @validate_call
    async def messages_unread_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _messages_unread_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,

...
import inaturalist_client.models
from inaturalist_client import rest
from inaturalist_client.api_response import ApiResponse
from inaturalist_client.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(inaturalist_client.models, klass)
